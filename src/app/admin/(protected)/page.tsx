...
export default async function AdminDashboardPage({ searchParams }: { searchParams: Promise<Record<string, string | string[] | undefined>> }) {
    ...
    return (
        <div className="mx-auto max-w-[1500px]">
            <StatusToast type={error ? 'error' : undefined} message={error} />
            ...
            <section className="mb-5">
                <TrafficAnalyticsPanel
                    ...
                    description="See the weekday traffic pattern, active browsing sessions and how many public pages are opened."
                />
            </section>

            <section className="grid items-start gap-4 xl:grid-cols-[minmax(0,1.5fr)_minmax(320px,0.5fr)]">
                ...
                <div className={`${panelClass} p-5 sm:p-6`}>
                    ...
                    <div className="mt-5 rounded-xl border border-foreground/10 bg-background/40 px-4 py-3 text-[11px] leading-5 text-muted-foreground">
                        Traffic aggregates expire after about {TRAFFIC_METRIC_RETENTION_DAYS} days. Short-lived traffic sessions, including country-resolution IP data when needed, expire after about {TRAFFIC_SESSION_RETENTION_HOURS} hours.
                    </div>
