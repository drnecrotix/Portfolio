        ...
        <div className="mx-auto max-w-6xl">
            <div className="mb-5 flex flex-wrap items-end justify-between gap-4">
                <div>
                    ...
                    <p className="mt-2 max-w-2xl text-sm leading-6 text-muted-foreground">Manage only the formal PDF layer here. Professional experience and education continue to come from Journey, while identity data comes from Wiki and Site Settings.</p>
                </div>
            ...
            <div className="mb-4 rounded-xl border border-sky-500/15 bg-sky-500/[0.04] px-4 py-3 text-xs leading-5 text-muted-foreground">PDF files are uploaded through Media Library. You can use one PDF for both browser viewing and downloading, or maintain separate versions for each action.</div>
