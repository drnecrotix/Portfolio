            ...
            <div className="mx-auto max-w-6xl">
                <header className="max-w-4xl">
                    <div className="flex flex-wrap items-center gap-x-3 gap-y-2 font-mono text-[10px] font-bold uppercase tracking-[0.24em] text-muted-foreground">
                        <span className="text-sky-500">NecrotixLab</span><span aria-hidden="true">/</span><span>Website Inspector</span><span aria-hidden="true">/</span><span>v1.2.59</span>
                    </div>
                ...
                {inspection ? (
                    <section className="mt-10">
                        ...
                        <ServiceRequestForm key={inspection.checkedAt} source="WEBSITE_INSPECTOR" target={inspection.finalUrl} score={inspection.score} issues={actionable} defaultCms={detectedCms} snapshot={{ checkedAt: inspection.checkedAt, grade: inspection.grade, statusCode: inspection.statusCode, technologies: inspection.page.technologies, wordpress: inspection.page.wordpress }} />
                    </section>
