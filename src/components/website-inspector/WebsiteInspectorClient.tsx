            ...
            <div className="mx-auto max-w-6xl">
                ...
                {inspection ? (
                    <section className="mt-10">
                        ...
                        <ServiceRequestForm source="WEBSITE_INSPECTOR" target={inspection.finalUrl} score={inspection.score} issues={actionable} defaultCms={detectedCms} snapshot={{ checkedAt: inspection.checkedAt, grade: inspection.grade, statusCode: inspection.statusCode, technologies: inspection.page.technologies, wordpress: inspection.page.wordpress }} />
                    </section>
