    ...
    return (
        ...
        >
            ...
            <section>
                ...
                <p className="mt-4">NecrotixLab does not use the website data described here to make decisions about visitors that produce legal or similarly significant effects. A/B variants are randomly assigned for interface comparison, and experiment statistics are used only as aggregate product-improvement decision support. Traffic analytics is used for aggregate site measurement and short-lived live monitoring, not individual profiling. The AI assistant generates conversational responses but is not used for automated eligibility, employment, credit or similar decisions.</p>
            </section>
