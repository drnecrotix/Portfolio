    ...
    return (
        <div className="mx-auto max-w-6xl">
            <div className="mb-5">
                ...
                <p className="mt-2 max-w-2xl text-sm leading-6 text-muted-foreground">A single non-destructive watermark shared by Blog article images and Project images. Gallery continues to use its own per-work copyright watermark.</p>
            </div>
