    ...
    return (
        ...
        >
            ...
            <section>
                ...
                <p className="mt-3">Country and city headers supplied by hosting/CDN infrastructure are preferred. When city data is not supplied and a public client IP address is available, the server can send that IP to <strong>ipwho.is</strong> for a short-lived country/city lookup. Only the country code and coarse city label are kept with retained page activity; latitude, longitude and other precise coordinates returned by a provider are not stored. Raw IP context is shown only for recent administration analytics and is intended to be cleared from page-activity records after about 24 hours. The page path, country, city and broad device class can remain for up to about 31 days.</p>
