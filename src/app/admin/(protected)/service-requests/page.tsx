                                ...
                                <div className="border-t border-white/5 pb-7 pt-5 md:pl-[150px]">
                                    ...
                                    <div className="grid gap-7 xl:grid-cols-[minmax(0,1fr)_390px]">
                                        <div>
                                            ...
                                            <p className="mt-5 font-mono text-[9px] font-bold uppercase tracking-[0.15em] text-white/35">{request.source === 'WEBSITE_BUILD' ? 'Selected project requirements' : request.source === 'WEBSITE_IMPROVEMENT' ? 'Selected improvement requirements' : request.source === 'WEBSITE_SUPPORT' ? 'Selected support requirements' : 'Selected audit findings'}</p>
