    ...
    return (
        <main className="min-h-screen bg-background px-5 pb-24 pt-28 text-foreground sm:px-8 lg:pt-36">
            <div className="mx-auto max-w-5xl">
                ...
                <section className="border-b border-border/80 py-6">
                    <p className="font-mono text-[9px] font-bold uppercase tracking-[0.16em] text-muted-foreground">{request.source === 'WEBSITE_BUILD' ? 'Selected project requirements' : request.source === 'WEBSITE_SUPPORT' ? 'Selected support requirements' : 'Selected findings'}</p>
