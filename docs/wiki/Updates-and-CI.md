...
CI uses a clean PostgreSQL database to verify Prisma Client generation, schema validation, production migration deployment, migration status and the shared runtime singleton guard.
